...
ground = createSprite(350,350,windowWidth, windowHeight);
  ...
  //bike
  bike = createSprite(350,320,50,50);
  bike.addAnimation("bikeimg",bikeimg);
  bike.scale = 0.6;

  //rockstar
  rockstar = createSprite(width/2-20,height/2-20,50,50);
  ...
  GAMEOVER = createSprite(width/2, height/2-20,30,20);
...
function spawncars() {
  if(frameCount % 60 === 0) {
     car = createSprite(600,height-100,10,40);

    car.velocityY = -(8+2*score/150);
      car.scale = 1.2;
...
function spawncars4() {
  if(frameCount % 180 === 0) {
     car = createSprite(500,height-250,10,40);
    car.velocityY = -(8+2*score/150);
      car.scale = 1.2;
